                    ...
                    <div class="cart-table">
                        <table>
                            <thead>
                                ...
                                <th>Quantity</th>
                                <th>Total</th>
                                <th><a href="{{ route('get.destroy.cart') }}"><i
                                            onclick="confirm('Are you sure you want to delete all product?')"
                                            class="ti-close"></i></a></th>
                            </thead>
                            <tbody>
                                @foreach ($carts as $cart)
                                    <tr>
                                        <td class="cart-pic first-row"><img src="frontend/Images/{{ $cart->image }}"></td>
                                        ...
                                        <td class="close-td first-row"><a
                                                href="{{ route('get.delete.cart', $cart->rowId) }}"><i
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 offset-lg-4">
                            <div class="proceed-checkout">
                                ...
                                <a href="{{ route('get.view.checkout') }}" class="proceed-btn">PROCEED TO CHECK OUT</a>
                            </div>
                        </div>
                    </div>
                </div>
