...
<head>
    ...
    <title>Order Notification - Molla Shop</title>
</head>
...
<body
    ...
    <div class="container-fluid">
        <div class="container" style="background-color: #e7eff8; width: 600px; margin: auto;">
            <div class="col-12 mx-auto" style="width: 500px; margin: 0 auto;">
                <div class="row">
                    <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row mt-5" style="margin-top: 35px; display:flex;">
                            ...
                            <div class="col-6" style="flex: 0 0 50%; width: 50%; box-sizing:border-box;">
                                ...
                                <br>
                                <b>Address:</b> {{ $order->street_address . ' - ' . $order->town_country }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-2 p-4" style="background-color: white; margin-top: 15px; padding: 20px;">
                    <table>
                        <tr>
                            <td>
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgWWKOUY8S5NVCvOMvmSRf2MKSS84DH0XAog&usqp=CAU"
                                    alt="">
                            </td>
                            ...
                            @if ($order->payment_type == 'online_payment')
                                <td class="pl-3" style="padding-left: 15px;">
                                    <span class="d-inline"
                                        style="color:#424853; font-family: trebuchet, sabs-serif; font-size: 16pxl font-weight: normal; line-height: 22px;">
                            ...
                            <table class="table table-sm table-hover"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="padding: 5px 20px 0; text-align: right;">TOTAL</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($order->orderDetails as $orderDetail)
                                        <tr>
                                            ...
                                            <td
                                                style="border-top: 1px solid #dee2e6; padding: 5px 20px 5px 0; text-algin: right;">
                                                {{ $orderDetail->total }} $
                                            </td>
                                        </tr>
                                    @endforeach
                ...
                <div class="row mt-2" style="margin-top: 15px;">
                    <div class="container-fluid">
                        ...
                        <div class="row pl-3 py-2"
                            style="background-color: #fff; font-size: 10px; padding: 2px 20px 10px 20px;">
                            <div class="col-12 p-0">
                                ...
                                <table class="mt-2 w-100"
                                    ...
                                    <tr style="font-size: 18px;">
                                        <td><b>TOTAL</b></td>
                                        <td class="pr-3 text-right" style="text-algin: right; padding-right: 20px;">
                                            <b>{{ $total }}</b>
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row pl-3 py-2" style="background-color: #fff; padding: 10px 20px;">
                            <p>You can check the appearance of the product (brand, model, color, quantity,...) before
                                payment and can refuse to recevive the goods if not satisfied. Please do not activate an
                                electrical-electronic device or try product.</p>
                            <p>If the product shows sighns of damage / broken or does not match the information on the website, please contact the store within 48 hours from the time of receipt for assistance/</p>
                            <p>Please keep the invoice, product box and warranty card (if any) for return or waranty when needed</p>
                            <p>You can refer to the Help Center page or contact the store by leaving a message at the Contact page or mailing here. Hotline 1900 9999 (8:00 - 9:00 both Saturday and Sunday).</p>

                            <b>Molla shop thank you.</b>
                        </div>
                    </div>
                </div>
